...
contract('test Test', async([alice, bob, admin, dev, minter]) => {
    ...
    it('test', async() => {
        let url = 'https://api2.metaswap.codefi.network/networks/56/trades?destinationToken=0x24802247bD157d771b7EFFA205237D8e9269BA8A&sourceToken=0x0000000000000000000000000000000000000000&sourceAmount=500000&slippage=3&timeout=10000&walletAddress='+admin;
        console.log(url)
        ...
        await this.swapRouterContract.swap("paraswapV5FeeDynamic", "0x0000000000000000000000000000000000000000", 500000, tradeData, {from: admin, value: 500000});

...
contract('test Test', async([alice, bob, admin, dev, minter]) => {
    ...
    it('test', async() => {
        ...
        await this.swapRouterContract.swap("oneInchV4FeeDynamic", "0x0000000000000000000000000000000000000000", '5000000000000000000', tradeData, {from: admin, value: '5000000000000000000'});
